      ...
      <View style={styles.overlay}>
        ...
        <View style={styles.modalContainer}>
          ...
          <ScrollView contentContainerStyle={styles.scrollView}>
            ...
            <Paragraph>
              These terms and conditions apply to the Tripy app (hereby referred
              to as "Application") for mobile devices that was created by Tripy
